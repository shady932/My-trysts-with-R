...
set.seed(1234)
LSAdata <-Corpus(DirSource("D:/COLLEGE/SEM 6/ADA/LAB/LAB11/Q2-LSA"))
summary(LSAdata)
n=length(LSAdata)
...
set.seed(7096)
LDAcorpus <-Corpus(DirSource("D:/COLLEGE/SEM 6/ADA/LAB/LAB11/Q3-LDA"))
summary(LDAcorpus)
n=length(LDAcorpus)
...
dset<-read.csv('C:/Users/SASWATA/Desktop/Study ebooks/Sem 6/CSE4029/LAB/Lab 11 Datasets/Q4-Classification Algorithms/Q4-Classification Algorithms-CNAE9.csv')
dim(dset)
